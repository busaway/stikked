			...
			<div class="container">			
				<div class="header">
					...
					<ul class="tabs">
						...
						<li><a  <?php if($l == "about"){ echo 'class="active"'; }?> href="<?=site_url("about/")?>" title="About Page">About</a></li>
					</ul>
				</div>
<div><?php echo $this->uri->uri_string() . $this->config->site_url() .  $_SERVER['REQUEST_URI'] ?></div>
				<div class="content">
					<div class="container">
